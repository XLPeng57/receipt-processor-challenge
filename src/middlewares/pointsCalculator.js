...
const calculatePoints = (receipt) => {
    ...
    receipt.items.forEach(element => {
        if (element.shortDescription.trim().length % 3 === 0) {
            ...
            // console.log(`Rule 5: ${Math.ceil(parseFloat(element.price) * 0.2)}`);
        }
